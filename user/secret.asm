...
main(int argc, char *argv[])
{
  ...
  14:	8c050513          	addi	a0,a0,-1856 # 8d0 <malloc+0xfc>
  18:	708000ef          	jal	720 <printf>
    exit(1);
  1c:	4505                	li	a0,1
  ...
  2a:	8ca58593          	addi	a1,a1,-1846 # 8f0 <malloc+0x11c>
...
malloc(uint nbytes)
{
 ...
 832:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
 834:	00008797          	auipc	a5,0x8
 838:	7dc78793          	addi	a5,a5,2012 # 9010 <base>
